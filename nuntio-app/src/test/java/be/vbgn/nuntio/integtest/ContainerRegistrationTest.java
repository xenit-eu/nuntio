...
public class ContainerRegistrationTest {
    ...
    @ContainerTests
    @Nested
    public class RegistratorCompat {
    ...
    @ContainerTests
    @Nested
    public class NuntioConfig {
        private NuntioContainer nuntioRegistratorCompatContainer = new NuntioContainer()
                .withNetwork(network)
                .withConsulContainer(consulContainer)
                .withDindContainer(dindContainer)
                .withRegistratorCompat(true);

        private NuntioContainer nuntioOnlyContainer = new NuntioContainer()
                .withNetwork(network)
                .withConsulContainer(consulContainer)
                .withDindContainer(dindContainer);

        private NuntioContainer nuntioInternalPortsContainer = new NuntioContainer()
                .withNetwork(network)
                .withConsulContainer(consulContainer)
                .withDindContainer(dindContainer)
                .withInternalPorts(true);
